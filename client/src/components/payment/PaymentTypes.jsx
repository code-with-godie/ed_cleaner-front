...
import PayWithCardButton from '../../pages/checkout/PayWithCardButton';
    ...
    <Container>
        ...
        <ButtonWrapper>
            <button>click</button>
             ...
             { paymentType === 'mpesa' &&  <Button onClick={handlePay}  >mpesa <KeyboardArrowRight/> </Button> }
             { paymentType === 'paypal' &&  <Button onClick={handlePay}  >paypal <KeyboardArrowRight/> </Button> }
             </ButtonWrapper>
    </Container>
  )
}
